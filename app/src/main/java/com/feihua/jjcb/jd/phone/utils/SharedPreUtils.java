...
public class SharedPreUtils
{
    ...
    public synchronized static void getSharedPreferencesInstance(Context context)
    {
        if (preferences == null)
        {
            preferences = context.getSharedPreferences(Constants.SETTING_DB_NAME, Context.MODE_PRIVATE);
        }
    }
     ...
     * @return
     */
    public synchronized static void cancelSharedPreferencesInstance()
    {
        preferences = null;
    }
     ...
     * @param context 上下文
     */
    private static boolean putValue(String key, Object value, Context context)
    {
        SharedPreUtils.getSharedPreferencesInstance(context);
    ...
    {
        boolean putValue = putValue(key, value, context);
        return putValue;
    }
