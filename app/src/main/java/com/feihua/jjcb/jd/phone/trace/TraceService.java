package com.feihua.jjcb.jd.phone.trace;
...
import com.feihua.jjcb.jd.phone.bean.LocationInfoBean;
...
public class TraceService extends Service
{
    ...
    public void onCreate()
    {
        ...
        builder.setContentTitle("晋东抄表轨迹服务");
        builder.setContentText("晋东抄表轨迹服务");
    ...
    private void timerControlSwitch()
    {
        ...
        TimerTask task = new TimerTask()
        {
            ...
            public void run()
            {
                L.w("TraceService", "getWorkState() = " + getWorkState()+" --- isStart = "+isStart);
                if (getWorkState())
                {
                    if (!isStart)
                    {
                        L.w("TraceService", "startTrace() = ");
