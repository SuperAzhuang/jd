...
import com.feihua.jjcb.jd.phone.Adapter.BiaoCeAdapter;
import com.feihua.jjcb.jd.phone.R;
import com.feihua.jjcb.jd.phone.asynctask.DownBiaoKuangAsyncTask;
import com.feihua.jjcb.jd.phone.asynctask.DownTablesAsyncTask;
import com.feihua.jjcb.jd.phone.callback.BiaoCeTables;
import com.feihua.jjcb.jd.phone.callback.CommonCallback;
import com.feihua.jjcb.jd.phone.callback.DownTables;
import com.feihua.jjcb.jd.phone.callback.DownTablesCallback;
...
import com.feihua.jjcb.jd.phone.ui.CBGLListActivity;
...
public class CBGLfragment extends BaseFragment implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    private void downTables() {
        ...
        StringBuilder    append = new StringBuilder(Constants.DOWN_TABLES).append("?USER_ID=").append(userId).append("&VOL_NO=").append(VOLUME_NO);
