...
import com.feihua.jjcb.jd.phone.Adapter.CBGLDetailsViewPagerAdapter;
...
import com.feihua.jjcb.jd.phone.shark.OnSharkListener;
import com.feihua.jjcb.jd.phone.shark.SharkUtil;
import com.feihua.jjcb.jd.phone.utils.DepthPageTransformer;
...
public class CBGLDetailsActivity extends BaseActivity implements View.OnClickListener, ViewPager.OnPageChangeListener
{
    ...
    {
//        Node stNode = new Node(118.102571,24.494428,"飞华");
//        Node enNode = new Node(118.104781,24.4947,"金星");
//        initUtil.toNavi(stNode,enNode);
    ...
    private void initView()
    {
        ...
        adapter = new CBGLDetailsViewPagerAdapter(fm, khDatas,volumeNo,this);
