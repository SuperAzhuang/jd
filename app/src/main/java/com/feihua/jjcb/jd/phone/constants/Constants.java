package com.feihua.jjcb.jd.phone.constants;
...
//    http://218.207.198.160:1439/
    ...
    public static final String CBGL_CHAO_BIAO_ACTION = "com.feihua.jjcb.jd.phone.cbgl.chaobiao.action";//抄表管理列表广播
    public static final String CBGL_BIAO_CE_ACTION = "com.feihua.jjcb.jd.phone.cbgl.biaoce.action";//表册广播
    ...
    public static final String TARGETSERVICE_DESTORY = "com.feihua.jjcb.jd.service.destroy";
    public static final String TRACESERVICE_DESTORY = "com.feihua.jjcb.jd.traceservice.destroy";
    public static final String LOGINTOKEN_ERROR_SERVICE = "com.feihua.jjcb.jd.service.logintoken";
