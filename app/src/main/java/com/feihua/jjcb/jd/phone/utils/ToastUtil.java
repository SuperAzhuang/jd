...
import com.feihua.jjcb.jd.phone.view.HandyTextView;
...
public class ToastUtil
{
    ...
    public static void show(String msg)
    {
        ...
        if (toast == null)
        {
            toast = Toast.makeText(Global.getApplicationContext(), msg, Toast.LENGTH_SHORT);
    ...
    public static void show(int resId)
    {
        ...
        if (toast == null)
        {
            toast = Toast.makeText(Global.getApplicationContext(), getToastString(resId), Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.CENTER, 0, 0);
            toast.show();
        }
        else
    ...
    public static void showShortToast(String text)
    {
        if (toast == null)
        {
            toast = Toast.makeText(Global.getApplicationContext(), text, Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.CENTER, 0, 0);
            toast.show();
        }
        else
    ...
    public static void showLongToast(int resId)
    {
        if (toast == null)
        {
            toast = Toast.makeText(Global.getApplicationContext(), getToastString(resId), Toast.LENGTH_LONG);
            toast.setGravity(Gravity.CENTER, 0, 0);
            toast.show();
        }
        else
    ...
    public static void showLongToast(String text)
    {
        if (toast == null)
        {
            toast = Toast.makeText(Global.getApplicationContext(), text, Toast.LENGTH_LONG);
            toast.setGravity(Gravity.CENTER, 0, 0);
            toast.show();
        }
        else
    ...
    {
        View toastRoot = LayoutInflater.from(Global.getApplicationContext()).inflate(R.layout.common_toast, null);
        ((HandyTextView) toastRoot.findViewById(R.id.toast_text)).setText(getToastString(resId));
