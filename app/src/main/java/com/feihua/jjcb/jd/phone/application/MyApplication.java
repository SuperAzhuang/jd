package com.feihua.jjcb.jd.phone.application;
...
import com.feihua.jjcb.jd.phone.utils.Global;
...
//                .addInterceptor(new LoggerInterceptor("TAG"))//
    ...
    private void initVoice()
    {
        ...
        // 注意： appid 必须和下载的SDK保持一致，否则会出现10407错误57df3799

        SpeechUtility.createUtility(this, "appid=" + "57df3799");
